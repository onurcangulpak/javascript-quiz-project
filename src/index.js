document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    progressBar.style.width = `${percentageProgress}%`; // This value is hardcoded as a placeholder
  ...
  function showResults() {
    ...
    resultContainer.innerText = `You scored ${quiz.questions.length} out of ${quiz.correctAnswers} correct answers!`; // This value is hardcoded as a placeholder
  }
